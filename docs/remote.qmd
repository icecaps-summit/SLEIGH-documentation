# Remote Connection during Summer 2023 {.unnumbered}
...
3. If the VNC connection works properly, you should be prompted to enter the password for iceman, which is iceman.
